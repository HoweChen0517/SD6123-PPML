...
from utils.opacus_clientprox import OpacusClientProx
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FedProx with Opacus DP-SGD and Membership Inference Attack")
    ...
    os.makedirs(os.path.join("result", "fedprox_opacus_MIA"), exist_ok=True)
    run(args)
