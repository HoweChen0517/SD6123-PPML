...
def run(args):
    ...
    clients = [
        Client(args, idx, model_fn, bundle.client_loaders[idx], bundle.client_val_loaders[idx], bundle.client_test_loaders[idx])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="FedAvg with DP-SGD and Membership Inference Attack")
    ...
    os.makedirs(os.path.join("result", "fedavg_dp_MIA"), exist_ok=True)
    run(args)
